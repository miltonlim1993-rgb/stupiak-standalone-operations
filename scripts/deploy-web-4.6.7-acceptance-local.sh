...
EXPECTED_WORKER_REVISION="printer-hardware-profiles-v4.6.7"
EXPECTED_SHELL_VERSION="chefops-v4-6-7-printer-hardware-profiles-shell-v10"
...
echo
echo "=================================================="
echo "3. Build and test Web 4.6.7"
echo "=================================================="
...
echo
echo "=================================================="
echo "5. Verify production 4.6.7"
echo "=================================================="
VERIFIED=""
for attempt in $(seq 1 18); do
  HEADERS="$(curl -fsSI --max-time 20 "$WORKER_URL/?acceptance=4.6.7-$COMMIT-$attempt" || true)"
  SHELL="$(curl -fsS --max-time 20 "$WORKER_URL/sw.js?acceptance=4.6.7-$COMMIT-$attempt" || true)"
...
if [[ "$VERIFIED" != "yes" ]]; then
  echo "ERROR: Deployment completed but the 4.6.7 revision markers were not visible."
  printf '%s\n' "$HEADERS"
  exit 1
fi
...
echo
echo "=================================================="
echo "6. Trigger production-signed Android 4.6.7 build"
echo "=================================================="
...
echo
echo "=================================================="
echo "SUCCESS: Web 4.6.7 and signed Android release completed"
echo "=================================================="
echo "URL: $WORKER_URL"
echo "Commit: $COMMIT"
