...
printf '\n==================================================\n'
echo "1. Pull and verify Android 4.6.22 shared date fit"
echo "=================================================="
...
grep -q "4.6.22-windows-queue-kitchen-ip-service-v24" web/src/main.jsx
...
grep -q '4.6.22-windows-queue-kitchen-ip-v24-date-fit-v22' .github/workflows/android-apk.yml
...
printf '\n==================================================\n'
echo "3. Trigger production-signed Android 4.6.22 build"
echo "=================================================="
...
printf '\n==================================================\n'
echo "SUCCESS: Signed Android 4.6.22 date-fit release completed"
echo "=================================================="
echo "Source commit: $COMMIT"
echo "Android workflow run: $ANDROID_RUN_ID"
echo "Stable APK: stupiaks-ops-stable-tspl-v16.apk"
echo "Made/Use By dates: same shared Web core, narrow 1x2 font, centered, 2-dot safe edge"
echo "Unchanged: Native RAW TSPL, 40x30 mm, 203 dpi, Gap 2 mm, offsets, Wi-Fi/LAN/Bluetooth"
echo "Web/Worker were not deployed by this script."
