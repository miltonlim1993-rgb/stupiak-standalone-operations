...
assert.match(budgetSource, /const VERSION = 'bounded-global-sync-v2-pressure-aware'/)
...
assert.match(budgetSource, /Boolean\(args\?\.refresh\) && visibleUserAction\(\)/)
...
assert.match(budgetSource, /worker_pressure:/)
...
console.log('WORKER_PRESSURE_AWARE=true')
