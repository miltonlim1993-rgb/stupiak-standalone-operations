...
requireText('web/src/pages/OperationalTasksLive.jsx', 'window.requestIdleCallback(runSave)', 'idle Task autosave scheduling')
requireText('web/src/pages/OperationalTasksLive.jsx', "document.addEventListener('focusout'", 'immediate blur save')
requireText('web/src/pages/OperationalTasksLive.jsx', "window.addEventListener('pagehide'", 'leave-page draft flush')
requireText('web/src/pages/OperationalTasksLive.jsx', 'pendingCloseButton.current', 'save-before-close drawer guard')
requireText('web/src/pages/OperationalTasksLive.jsx', 'waitForAvailableSaveButton', 'event-based retry when save button becomes available')
...
console.log('EVENT_DRIVEN_TASK_AUTOSAVE=true')
