...
assert(cameraSource.includes('照片已取得并显示'), 'captured photo must be visibly previewed before save confirmation')
assert(cameraSource.includes('chefops:task-photo-sync-state'), 'camera preview must wait for TaskPhoto persistence state')
