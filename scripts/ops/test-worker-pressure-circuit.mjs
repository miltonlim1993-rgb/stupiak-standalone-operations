...
assert.match(circuitSource, /const HARD_PRESSURE_STATUSES = new Set\(\[429, 502, 504\]\)/)
assert.match(circuitSource, /const SOFT_PRESSURE_STATUSES = new Set\(\[408, 425, 500, 501, 503, 505\]\)/)
...
assert.match(budgetSource, /canonicalMethodProbeSucceeded/)
...
console.log('WORKER_PRESSURE_SOFT_503_THRESHOLD=2')
