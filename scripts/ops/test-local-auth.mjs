...
assert.match(emailApprovalSource, /email_approval_session_promoted/)
...
assert.match(opsControl, /One approval, automatic entry/)
...
console.log('APPROVAL_SESSION_AUTO_PROMOTION=true')
