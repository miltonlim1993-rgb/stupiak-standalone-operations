...
printf '\n==================================================\n'
echo "1. Pull and verify Android 4.6.20 shared date fit"
echo "=================================================="
...
grep -q '"version": "4.6.20"' package.json
...
grep -q '4.6.20-stable-tspl-v16-date-fit-v22' .github/workflows/android-apk.yml
...
printf '\n==================================================\n'
echo "3. Trigger production-signed Android 4.6.20 build"
echo "=================================================="
...
printf '\n==================================================\n'
echo "SUCCESS: Signed Android 4.6.20 date-fit release completed"
echo "=================================================="
...
echo "Unchanged: 40x30 mm, 203 dpi, Gap 2 mm, offsets, RAW TSPL, Wi-Fi/LAN/Bluetooth"
