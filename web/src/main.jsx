...
const SHELL_VERSION = 'task-photo-save-zoom-pwa-v38'
...
async function registerBackgroundAlertChecks(registration) {
  ...
  try {
    ...
    console.info('One-time background Task alert check is not available in this browser', error)
  }
}
...
if ('serviceWorker' in navigator && import.meta.env.PROD && !isNativeAndroid()) {
  ...
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('/sw-v38.js', { updateViaCache: 'none' }).then((registration) => {
