  ...
  useEffect(() => {
    ...
    const stop = startRealtimeConnections({
      ...
      onEvent: (event) => {
        ...
        // Refresh active React Query data without reloading the page. This keeps
        // open forms, scroll position and captured media intact while another
        // device's Task, Stock Count, Close Up or Issue appears immediately.
