  ...
  return `
    <section class="page page-home">
      ...
      <div class="module-grid home-modules">
        <button class="module-card dashboard-module" data-route="dashboard">
          <div class="module-icon amber">${icon('dashboard', 25)}</div>
          <div class="module-copy"><span>Operations Dashboard</span><strong>Monthly overview · Custom date filters</strong><small>Review stock quantities and cash events across every file.</small></div>
          ${icon('arrow')}
        </button>
